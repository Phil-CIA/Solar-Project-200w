...
| PV_IN_NEG | PV Input | In | Negative PV return rail | REQ-PV-001 |
...
| CHG_OUT_NEG | Charger Output | Out | Charger return output to battery interface | REQ-CHG-001 |
| BAT_BUS_POS | Battery Bus | Bidirectional | Battery positive bus boundary | REQ-BAT-001 |
| BAT_BUS_NEG | Battery Bus | Bidirectional | Battery return bus boundary | REQ-BAT-001 |
